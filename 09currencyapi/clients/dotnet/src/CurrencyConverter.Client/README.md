...
additionalProperties:
  packageGuid: '{64CAB40B-21EA-4FD8-9C04-5BB64FC72329}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            var api = host.Services.GetRequiredService<ICurrencyConversionApi>();
            IGetCurrencyRatesApiResponse apiResponse = await api.GetCurrencyRatesAsync("todo");
            Dictionary<string, Dictionary<string, double>>? model = apiResponse.Ok();
        }

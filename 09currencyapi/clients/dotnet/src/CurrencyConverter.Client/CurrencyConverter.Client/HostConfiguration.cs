...
{
    /// <summary>
    /// Provides hosting configuration for CurrencyConverter.Client
    /// </summary>
    public class HostConfiguration
    {
        ...
        public HostConfiguration(IServiceCollection services)
        {
            ...
            _jsonOptions.Converters.Add(new SupportedCurrenciesResponseJsonConverter());
            JsonSerializerOptionsProvider jsonSerializerOptionsProvider = new(_jsonOptions);
            _services.AddSingleton(jsonSerializerOptionsProvider);
            _services.AddSingleton<IApiFactory, ApiFactory>();
            _services.AddSingleton<CurrencyConversionApiEvents>();
            _services.AddSingleton<CurrencyInformationApiEvents>();
            ...
            Action<HttpClient>? client = null, Action<IHttpClientBuilder>? builder = null)
        {
            ...
            builders.Add(_services.AddHttpClient<ICurrencyConversionApi, CurrencyConversionApi>(client));
            builders.Add(_services.AddHttpClient<ICurrencyInformationApi, CurrencyInformationApi>(client));

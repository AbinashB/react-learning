...
{
    /// <summary>
    ///  Class for testing CurrencyInformationApi
    /// </summary>
    public sealed class CurrencyInformationApiTests : ApiTestsBase
    {
        private readonly ICurrencyInformationApi _instance;

        public CurrencyInformationApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<ICurrencyInformationApi>();
        }
        ...
        public async Task GetSupportedCurrenciesAsyncTest()
        {
            ...
            Assert.IsType<SupportedCurrenciesResponse>(model);
        }
    }
}
